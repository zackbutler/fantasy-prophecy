...
data1 = pd.read_csv("dlstats_2015_2017.csv")
data2 = pd.read_csv("dlstats_2012_2014.csv")
data3 = pd.read_csv("dlstats_2009_2011.csv")
...
print(data.loc[data['Name'] == "Ryan, Matt"])
#dataLarry = [13.7, 13.2, 14.318, 9.675, 11.6375, 10.1, 14.71875, 13.3625, 14.287]
